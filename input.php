...
<body class="app">
  ...
  if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['distrik']) || empty($_POST['komoditas']) || empty($_POST['luasLahan']) || empty($_POST['luasPanen']) || empty($_POST['dp']) || empty($_POST['tanggal'])) {
      ...
      $luasPanen = htmlspecialchars($_POST['luasPanen'], ENT_QUOTES, 'UTF-8');
            ...
            <table cellpadding="10">
              ...
              <form class="app-search-form" method="post">
                ...
                <tr>
                  ...
                  <td>
                    <input id="#luasPanen" type="number" class="form-control" name="luasPanen" step="0.01" min="0" require />
                  </td>
                </tr>

                <tr>
                  <td>
                    <label for="#dps">Data Produksi (KW)</label>
                  </td>
                  <td>
                    <input id="#dps" type="number" class="form-control" name="dp" step="0.01" min="0" require />
                  </td>
                </tr>
